...
export const PERMISSION_KEYS = {
  ...
  AFTER_SALES_RECOVERY_CORRECT: '售后服务/售后挽回订单更正',
  AFTER_SALES_RECOVERY_DELETE: '售后服务/删除售后挽回订单',
  AFTER_SALES_RECOVERY_HISTORY: '售后服务/售后挽回订单修改记录',
  AFTER_SALES_RECOVERY_EXPORT: '售后服务/售后挽回订单列表/导出售后挽回订单',
  ...
  FINANCE_PAYOUT_REPORT_EXPORT: '财务中心/月度发放/导出提成月度报告',
  FINANCE_REFUND: '财务中心/售后挽回分账',
  FINANCE_FLOW: '财务中心/收支流水',
  FINANCE_FLOW_EXPORT: '财务中心/收支流水/导出收支流水',
  ...
  /** @deprecated 仅用于历史角色兼容，新授权使用 MARKETING_PUBLISH。 */
  ...
  // Stored permission keys stay stable; product-facing labels are defined by the role editor.
  MARKETING: '营销内容中心',
  MARKETING_CONTENT: '营销内容中心/内容库',
  MARKETING_REVIEW: '营销内容中心/内容审核',
  MARKETING_PUBLISH: '营销内容中心/发布任务',
  MARKETING_GROUPS: '营销内容中心/账号分组',
  ...
  ACADEMY: '极享商学院',
  ACADEMY_VIEW: '极享商学院/查看工作台',
  ACADEMY_PLAN_MANAGE: '极享商学院/课程计划',
  ACADEMY_COURSE_MANAGE: '极享商学院/课程管理',
  ACADEMY_SESSION_MANAGE: '极享商学院/场次运营',
  ACADEMY_ENGAGEMENT_MANAGE: '极享商学院/学员与转化',
  ACADEMY_REVIEW_MANAGE: '极享商学院/经营复盘',

  ENTERPRISE_BRAIN: '企业AI大脑',
  STANDARD_READ: '企业AI大脑/标准中心/读取岗位标准',
  STANDARD_MAINTAIN: '企业AI大脑/标准中心/维护岗位标准',
  STANDARD_PUBLISH: '企业AI大脑/标准中心/发布岗位标准',
  TASK_SELF: '企业AI大脑/任务中心/本人任务',
  TASK_TEAM: '企业AI大脑/任务中心/团队任务',
  TASK_ASSIGN: '企业AI大脑/任务中心/指派任务',
  TASK_CONFIRM: '企业AI大脑/任务中心/确认任务',
  REVIEW_SELF: '企业AI大脑/复盘中心/本人复盘',
  REVIEW_TEAM: '企业AI大脑/复盘中心/团队复盘',
  AI_POSITION_ASSISTANT: '企业AI大脑/AI助手/岗位问答',
  AI_AUDIT: '企业AI大脑/AI助手/问答审计',
  BRAIN_DASHBOARD: '企业AI大脑/老板驾驶舱',

  OKR: '目标管理',
  OKR_SELF_READ: '目标管理/查看本人目标',
  OKR_TEAM_READ: '目标管理/查看团队目标',
  OKR_CREATE: '目标管理/创建目标',
  OKR_CHECK_IN: '目标管理/提交检视',
  OKR_DEPARTMENT_MANAGE: '目标管理/管理部门目标',
  OKR_COMPANY_MANAGE: '目标管理/管理公司目标',
  OKR_CYCLE_MANAGE: '目标管理/管理周期',
  OKR_SCORE_CLOSE: '目标管理/评分与关闭',
  OKR_METRIC_BIND: '目标管理/绑定经营指标',
...
export const CUSTOMER_BATCH_ACTION_PERMISSION_MAP = {
  ...
  update_lead_source: [PERMISSION_KEYS.CUSTOMER_BATCH_MANAGE, PERMISSION_KEYS.CUSTOMER_EDIT_ATTRIBUTION],
...
const PERMISSION_GRANT_TREE: Record<string, string[]> = {
  ...
  [PERMISSION_KEYS.LEADS_EDIT]: [PERMISSION_KEYS.LEADS_EDIT],
  [PERMISSION_KEYS.LEADS_FOLLOW]: [
    PERMISSION_KEYS.LEADS_FOLLOW,
    CAPABILITY_KEYS.LEADS_RECEIVE,
    PERMISSION_KEYS.LEADS_CONVERT,
  ...
  [PERMISSION_KEYS.ORDER_CORRECT]: [PERMISSION_KEYS.ORDER_CORRECT],
  ...
  [PERMISSION_KEYS.AFTER_SALES_RECOVERY_CORRECT]: [PERMISSION_KEYS.AFTER_SALES_RECOVERY_CORRECT],
  ...
  [PERMISSION_KEYS.AFTER_SALES_RECOVERY_EXPORT]: [PERMISSION_KEYS.AFTER_SALES_RECOVERY_EXPORT],
  ...
  [PERMISSION_KEYS.FINANCE_PAYOUT_REPORT_EXPORT]: [PERMISSION_KEYS.FINANCE_PAYOUT_REPORT_EXPORT],
  [PERMISSION_KEYS.FINANCE_FLOW]: [PERMISSION_KEYS.FINANCE_FLOW],
  [PERMISSION_KEYS.FINANCE_FLOW_EXPORT]: [PERMISSION_KEYS.FINANCE_FLOW_EXPORT],
  ...
  [PERMISSION_KEYS.ASSETS_MATRIX_PUBLISH]: [PERMISSION_KEYS.ASSETS_MATRIX_PUBLISH, PERMISSION_KEYS.MARKETING_PUBLISH],
  ...
  [PERMISSION_KEYS.MARKETING_CONTENT]: [PERMISSION_KEYS.MARKETING_CONTENT],
  [PERMISSION_KEYS.MARKETING_REVIEW]: [PERMISSION_KEYS.MARKETING_REVIEW],
  [PERMISSION_KEYS.MARKETING_PUBLISH]: [PERMISSION_KEYS.MARKETING_PUBLISH],
  [PERMISSION_KEYS.MARKETING_GROUPS]: [PERMISSION_KEYS.MARKETING_GROUPS],
  ...
  [PERMISSION_KEYS.ACADEMY_VIEW]: [PERMISSION_KEYS.ACADEMY_VIEW],
  [PERMISSION_KEYS.ACADEMY_PLAN_MANAGE]: [PERMISSION_KEYS.ACADEMY_PLAN_MANAGE],
  [PERMISSION_KEYS.ACADEMY_COURSE_MANAGE]: [PERMISSION_KEYS.ACADEMY_COURSE_MANAGE],
  [PERMISSION_KEYS.ACADEMY_SESSION_MANAGE]: [PERMISSION_KEYS.ACADEMY_SESSION_MANAGE],
  [PERMISSION_KEYS.ACADEMY_ENGAGEMENT_MANAGE]: [PERMISSION_KEYS.ACADEMY_ENGAGEMENT_MANAGE],
  [PERMISSION_KEYS.ACADEMY_REVIEW_MANAGE]: [PERMISSION_KEYS.ACADEMY_REVIEW_MANAGE],
  // 历史角色可能仍保存旧的赋能中台路径，只做单向兼容映射，
  // 不再让新商学院权限反向获得企业标准中心权限。
  ['赋能中台/极享商学院/查看工作台']: [PERMISSION_KEYS.ACADEMY_VIEW],
  ['赋能中台/极享商学院/课程管理']: [PERMISSION_KEYS.ACADEMY_COURSE_MANAGE],
  ['赋能中台/极享商学院/场次运营']: [PERMISSION_KEYS.ACADEMY_SESSION_MANAGE],
  ['赋能中台/极享商学院/邀约与到课']: [PERMISSION_KEYS.ACADEMY_ENGAGEMENT_MANAGE],
  ['赋能中台/极享商学院/课程复盘']: [PERMISSION_KEYS.ACADEMY_REVIEW_MANAGE],

  [PERMISSION_KEYS.ENTERPRISE_BRAIN]: [
    PERMISSION_KEYS.STANDARD_READ,
    PERMISSION_KEYS.STANDARD_MAINTAIN,
    PERMISSION_KEYS.STANDARD_PUBLISH,
    PERMISSION_KEYS.TASK_SELF,
    PERMISSION_KEYS.TASK_TEAM,
    PERMISSION_KEYS.TASK_ASSIGN,
    PERMISSION_KEYS.TASK_CONFIRM,
    PERMISSION_KEYS.REVIEW_SELF,
    PERMISSION_KEYS.REVIEW_TEAM,
    PERMISSION_KEYS.AI_POSITION_ASSISTANT,
    PERMISSION_KEYS.AI_AUDIT,
    PERMISSION_KEYS.BRAIN_DASHBOARD,
  ],
  [PERMISSION_KEYS.STANDARD_READ]: [PERMISSION_KEYS.STANDARD_READ],
  [PERMISSION_KEYS.STANDARD_MAINTAIN]: [PERMISSION_KEYS.STANDARD_MAINTAIN],
  [PERMISSION_KEYS.STANDARD_PUBLISH]: [PERMISSION_KEYS.STANDARD_PUBLISH],
  [PERMISSION_KEYS.TASK_SELF]: [PERMISSION_KEYS.TASK_SELF],
  [PERMISSION_KEYS.TASK_TEAM]: [PERMISSION_KEYS.TASK_TEAM],
  [PERMISSION_KEYS.TASK_ASSIGN]: [PERMISSION_KEYS.TASK_ASSIGN],
  [PERMISSION_KEYS.TASK_CONFIRM]: [PERMISSION_KEYS.TASK_CONFIRM],
  [PERMISSION_KEYS.REVIEW_SELF]: [PERMISSION_KEYS.REVIEW_SELF],
  [PERMISSION_KEYS.REVIEW_TEAM]: [PERMISSION_KEYS.REVIEW_TEAM],
  [PERMISSION_KEYS.AI_POSITION_ASSISTANT]: [PERMISSION_KEYS.AI_POSITION_ASSISTANT],
  [PERMISSION_KEYS.AI_AUDIT]: [PERMISSION_KEYS.AI_AUDIT],
  [PERMISSION_KEYS.BRAIN_DASHBOARD]: [PERMISSION_KEYS.BRAIN_DASHBOARD],
  ...
  [PERMISSION_KEYS.OKR_SELF_READ]: [PERMISSION_KEYS.OKR_SELF_READ],
  [PERMISSION_KEYS.OKR_TEAM_READ]: [PERMISSION_KEYS.OKR_TEAM_READ],
  [PERMISSION_KEYS.OKR_CREATE]: [PERMISSION_KEYS.OKR_CREATE],
  [PERMISSION_KEYS.OKR_CHECK_IN]: [PERMISSION_KEYS.OKR_CHECK_IN],
  [PERMISSION_KEYS.OKR_DEPARTMENT_MANAGE]: [PERMISSION_KEYS.OKR_DEPARTMENT_MANAGE],
  [PERMISSION_KEYS.OKR_COMPANY_MANAGE]: [PERMISSION_KEYS.OKR_COMPANY_MANAGE],
  [PERMISSION_KEYS.OKR_CYCLE_MANAGE]: [PERMISSION_KEYS.OKR_CYCLE_MANAGE],
  [PERMISSION_KEYS.OKR_SCORE_CLOSE]: [PERMISSION_KEYS.OKR_SCORE_CLOSE],
  [PERMISSION_KEYS.OKR_METRIC_BIND]: [PERMISSION_KEYS.OKR_METRIC_BIND],
...
export function roleHasPermission(role: Role | undefined, permissionKey: string, action = 'read'): boolean {
  ...
  // 超级管理员承担系统数据清理职责；客户删除仍会经过服务端业务关联保护。
...
function expandPermissionRequests(module: string): string[] {
  ...
  if (normalized === normalizePermissionKey(PERMISSION_KEYS.ACADEMY_VIEW)) {
    keys.add(normalizePermissionKey(PERMISSION_KEYS.ACADEMY_PLAN_MANAGE));
    keys.add(normalizePermissionKey(PERMISSION_KEYS.ACADEMY_COURSE_MANAGE));
    keys.add(normalizePermissionKey(PERMISSION_KEYS.ACADEMY_SESSION_MANAGE));
    keys.add(normalizePermissionKey(PERMISSION_KEYS.ACADEMY_ENGAGEMENT_MANAGE));
    keys.add(normalizePermissionKey(PERMISSION_KEYS.ACADEMY_REVIEW_MANAGE));
  }
  for (const [permissionKey, grants] of PERMISSION_GRANTS_BY_NORMALIZED.entries()) {
    if (
      normalized === normalizePermissionKey(PERMISSION_KEYS.ENABLEMENT)
      && permissionKey.startsWith(`${normalizePermissionKey(PERMISSION_KEYS.ENABLEMENT)}/极享商学院/`)
    ) continue;
...
export function hasPermission(
  ...
  // 无本地角色快照时仍识别认证态超级管理员；实际删除由后端再次鉴权并检查业务关联。
