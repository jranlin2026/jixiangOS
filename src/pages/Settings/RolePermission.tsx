...
const PERMISSION_TREE: RolePermissionNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: '课程排期', key: PERMISSION_KEYS.ACADEMY_PLAN_MANAGE },
      { label: '课程资产', key: PERMISSION_KEYS.ACADEMY_COURSE_MANAGE },
      { label: '场次执行', key: PERMISSION_KEYS.ACADEMY_SESSION_MANAGE },
      { label: '邀约、学员与转化交接', key: PERMISSION_KEYS.ACADEMY_ENGAGEMENT_MANAGE },
