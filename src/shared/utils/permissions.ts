...
export const PERMISSION_KEYS = {
  ...
  ORDER_EXPORT: '订单/订单列表/导出订单',
  ORDER_IMPORT: '订单/订单列表/导入订单',
  ...
  AFTER_SALES_RECOVERY_IMPORT: '售后服务/售后挽回订单列表/导入售后挽回订单',

  FINANCE: '财务中心',
  FINANCE_MY_COMMISSION: '财务中心/我的提成',
  FINANCE_OVERVIEW: '财务中心/财务总览',
  FINANCE_SETTLEMENT: '财务中心/订单分账',
  ORDER_SETTLEMENT_EXPORT: '财务中心/订单分账/导出订单分账',
  FINANCE_RECOVERY_SETTLEMENT: '财务中心/售后挽回分账',
  RECOVERY_SETTLEMENT_EXPORT: '财务中心/售后挽回分账/导出售后挽回分账',
...
const PERMISSION_GRANT_TREE: Record<string, string[]> = {
  ...
  [PERMISSION_KEYS.ORDER_EXPORT]: [PERMISSION_KEYS.ORDER_EXPORT],
  [PERMISSION_KEYS.ORDER_IMPORT]: [PERMISSION_KEYS.ORDER_IMPORT],
  ...
  [PERMISSION_KEYS.AFTER_SALES_RECOVERY_IMPORT]: [PERMISSION_KEYS.AFTER_SALES_RECOVERY_IMPORT],
  ...
  [PERMISSION_KEYS.ORDER_SETTLEMENT_EXPORT]: [PERMISSION_KEYS.ORDER_SETTLEMENT_EXPORT],
  [PERMISSION_KEYS.FINANCE_RECOVERY_SETTLEMENT]: [PERMISSION_KEYS.FINANCE_RECOVERY_SETTLEMENT],
  [PERMISSION_KEYS.RECOVERY_SETTLEMENT_EXPORT]: [PERMISSION_KEYS.RECOVERY_SETTLEMENT_EXPORT],
