...
register([STORAGE_KEYS.COMMISSION_PAYOUT_BATCHES],
  [PERMISSION_KEYS.FINANCE_PAYOUT], [PERMISSION_KEYS.FINANCE_PAYOUT]);
register([STORAGE_KEYS.COMMISSION_CORRECTIONS],
  [PERMISSION_KEYS.FINANCE_PAYOUT], [PERMISSION_KEYS.FINANCE_PAYOUT], false);
register([STORAGE_KEYS.FINANCE_TRANSACTIONS],
  [PERMISSION_KEYS.FINANCE_FLOW], [], false);
register([
...
const ORDER_CATALOG_READ_PERMISSIONS = [
  PERMISSION_KEYS.ORDER_CREATE,
  PERMISSION_KEYS.CUSTOMER_CREATE_ORDER,
] as const;
const PRODUCT_CATALOG_READ_PERMISSIONS = [
  ...ORDER_CATALOG_READ_PERMISSIONS,
...
register(
  [STORAGE_KEYS.PRODUCTS, STORAGE_KEYS.PRODUCT_LEVELS],
  [PERMISSION_KEYS.SETTINGS_PRODUCTS, ...PRODUCT_CATALOG_READ_PERMISSIONS],
...
register(
  ...
  [PERMISSION_KEYS.SETTINGS_ORDER_TYPES, ...ORDER_CATALOG_READ_PERMISSIONS],
...
register([STORAGE_KEYS.LEAD_SOURCE_CONFIGS],
  [
  ...
  [PERMISSION_KEYS.SETTINGS_LEAD_FLOW, PERMISSION_KEYS.SETTINGS_LEAD_SOURCES, PERMISSION_KEYS.LEADS_FLOW_CONFIG]);
register([STORAGE_KEYS.LEAD_FLOW_CONFIG, STORAGE_KEYS.LEAD_INTAKE_RECORDS],
