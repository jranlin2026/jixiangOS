...
interface UpgradeAnalysisProps {
  embedded?: boolean;
}

const UpgradeAnalysis: React.FC<UpgradeAnalysisProps> = ({ embedded = false }) => {
  return (
    <Box sx={{ p: embedded ? 0 : 3 }}>
      ...
      <Box sx={{ mt: 3, display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(5, 1fr)' }, gap: 2 }}>
        {[
