...
const CUSTOMER_CHANGE_FIELDS: Array<{ field: keyof Customer; label: string }> = [
  ...
  { field: 'sourcePlatformId', label: '来源平台' },
  { field: 'sourcePlatformName', label: '来源平台' },
...
const CUSTOMER_TO_LEAD_FIELDS: Array<{
  ...
  { customerField: 'sourcePlatformId', leadField: 'sourcePlatformId', label: '来源平台' },
  { customerField: 'sourcePlatformName', leadField: 'sourcePlatformName', label: '来源平台' },
  { customerField: 'sourceShopId', leadField: 'sourceShopId', label: '来源店铺' },
  { customerField: 'sourceShopName', leadField: 'sourceShopName', label: '来源店铺' },
  { customerField: 'platformOrderNo', leadField: 'platformOrderNo', label: '平台订单号' },
  { customerField: 'sourceProductId', leadField: 'sourceProductId', label: '平台购买产品' },
  { customerField: 'sourceProductName', leadField: 'sourceProductName', label: '平台购买产品' },
  { customerField: 'sourcePaymentAmount', leadField: 'sourcePaymentAmount', label: '平台付款金额' },
  { customerField: 'sourcePaymentAt', leadField: 'sourcePaymentAt', label: '平台付款时间' },
