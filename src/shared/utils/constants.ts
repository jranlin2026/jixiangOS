...
export const STORAGE_KEYS = {
  ...
  BUSINESS_RECYCLE_BIN_AUDITS: `${STORAGE_PREFIX}business_recycle_bin_audit`,
  ...
  MARKETING_CONTENTS: `${STORAGE_PREFIX}marketing_contents`,
  MARKETING_ACCOUNT_GROUPS: `${STORAGE_PREFIX}marketing_account_groups`,
...
/** 纯净首装时必须为空的业务数据及公司经营配置；组织与平台级配置不在此列表。 */
export const CLEAN_INSTALL_EMPTY_STORAGE_KEYS = [
  STORAGE_KEYS.LEADS,
