    ...
    children: [
      {
        ...
        permissionKeys: [PERMISSION_KEYS.MARKETING, PERMISSION_KEYS.MARKETING_CONTENT, PERMISSION_KEYS.MARKETING_REVIEW, PERMISSION_KEYS.MARKETING_PUBLISH, PERMISSION_KEYS.MARKETING_GROUPS],
      },
      {
  ...
  },
  {
    ...
    children: [
      { id: 'okr', label: '目标管理', path: ROUTES.OKR, permissionKeys: [...OKR_ACCESS_PERMISSION_KEYS] },
      {
        ...
        permissionKeys: [PERMISSION_KEYS.ENABLEMENT_KNOWLEDGE, PERMISSION_KEYS.ENABLEMENT_REVIEW, PERMISSION_KEYS.ENABLEMENT_PUBLISH, PERMISSION_KEYS.STANDARD_READ, PERMISSION_KEYS.STANDARD_MAINTAIN, PERMISSION_KEYS.STANDARD_PUBLISH],
      },
