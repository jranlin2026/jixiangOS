...
export const DEFAULT_ROLES: Role[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { module: PERMISSION_KEYS.CUSTOMER_DETAIL, actions: ['read'] },
  ...
  },
  {
    ...
    permissions: [
      ...
      { module: PERMISSION_KEYS.FINANCE_PAYOUT_REPORT_EXPORT, actions: ['read'] },
      ...
      { module: PERMISSION_KEYS.FINANCE_FLOW_EXPORT, actions: ['read'] },
