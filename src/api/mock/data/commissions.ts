...
const commissionEntries: Array<{
  ...
  { orderNo: 'ORD-202501-0005', customerName: '南京星辰数据', productLevel: '合伙人', orderAmount: 59800, owner: '王磊', status: '待确认', commissionRuleId: 'rule-007' },
  ...
  { orderNo: 'ORD-202501-0008', customerName: '武汉光电信息', productLevel: '课程', orderAmount: 2980, owner: '赵敏', status: '待确认', commissionRuleId: 'rule-003' },
  ...
  { orderNo: 'ORD-202501-0012', customerName: '昆明春城软件', productLevel: '贴牌', orderAmount: 29800, owner: '王磊', status: '待确认', commissionRuleId: 'rule-006' },
  ...
  { orderNo: 'ORD-202501-0015', customerName: '长沙融创智能', productLevel: '课程', orderAmount: 2980, owner: '王磊', status: '待确认', commissionRuleId: 'rule-004' },
  ...
  { orderNo: 'ORD-202501-0020', customerName: '广州云图教育', productLevel: '贴牌', orderAmount: 29800, owner: '赵敏', status: '待确认', commissionRuleId: 'rule-006' },
